...
## What Still Requires Real Data / Local Execution

- Downloading and importing the COCA dataset itself
- Obtaining and configuring the TotalSegmentator license
- Running mask generation on 30-50 scans
- Training the model and exporting final metrics
- Initializing a git repo or pushing this branch to GitHub
